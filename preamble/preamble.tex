...
\titleformat{\section}
  {\fontfamily{phv}\selectfont\huge\bfseries} % <--- "huge" rende il testo del titolo molto grande
  {\color{sapienza}\fontsize{20}{20}\selectfont\thesection} % <--- Numero ridotto a 18pt
  {12pt} % Spazio tra numero e titolo
  {} 
  [\vspace{4pt}{\color{sapienza!40}\titlerule[3pt]}] % Linea colorata un po' più spessa

\titleformat{\subsection}
  {\fontfamily{phv}\selectfont\Large\bfseries} % <--- "huge" rende il testo del titolo molto grande
  {\color{sapienza}\fontsize{16}{16}\selectfont\thesubsection} % <--- Numero ridotto a 18pt
  {12pt} % Spazio tra numero e titolo
  {} 
  [\vspace{4pt}{\color{sapienza!40}\titlerule[1.5pt]}] % Linea colorata un po' più spessa
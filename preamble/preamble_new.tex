...
\usepackage{mathpazo} % Replaced lmodern with Palatino font to match the image's serif style
...
% Updated header to match the image style (removed ornaments, added simple rule and italics)
\fancyhead[L]{\textit{Medical Robotics -- Final Project}} % Change this text as needed
\fancyhead[R]{\textit{Godot-Based Surgical Simulator}}    % Change this text as needed

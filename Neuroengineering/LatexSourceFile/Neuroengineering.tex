...
In the real life, we deal with system that are not completely deterministic, and they have some intrinsic randomness. We need some tools to evaluate the properties of systems of this kind.
...
estimation (called periodogram) can be obtained by taking the square of the absolute value of the DFT of the
...
\redText{TODO lezione 2026-04-08 minuto 56 circa}
...
\redText{TODO lezione 2026-04-15 minuto 54 circa}
\end{document}
...
The \textbf{Modularity} $Q$ measures the tendency of the subnetworks to form communities.
...
\end{figure}
To measure directly the motor action potential from a single fibre we need to insert a needle inside the muscle. 
\begin{figure}[H]
     \centering
...
\redText{TODO continua da lezione 2026-05-20 minuto 11.30}
\end{document}
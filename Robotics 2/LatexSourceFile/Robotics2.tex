...
\end{align}
Instead of finding the pseudo inverse, an iterative algorithm can be applied to find $\Delta\boldsymbol\varphi$ that considers sequentially the measurements.
\end{document}
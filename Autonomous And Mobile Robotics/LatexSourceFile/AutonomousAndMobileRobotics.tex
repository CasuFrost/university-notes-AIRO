...
\end{figure}
This representation also presents a problem: The distance between two configurations in $\mathcal C$ does not represent the true distance between two postures in the workspace: Two very distant configurations $\mathbf q_a$ and $\mathbf q_b$ in $\mathcal C$ can be mapped to two very close postures in $W$:
\begin{figure}[H]
    \centering
